...
import { mockJobs, searchJobs, getCategories, getSkills } from "@/data/mockJobs";
...
const JobListings = () => {
  ...
  const handleSearch = (filters: any) => {
    const results = searchJobs(filters.query, filters.skills.join(','), '');
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            Browse through {mockJobs.length}+ available opportunities across various domains
          </p>
        </div>
